...
std::ostream& operator<< (std::ostream& out, const svg::Color);

std::ostream& operator<< (std::ostream& out, const svg::StrokeLineCap);

std::ostream& operator<< (std::ostream& out, const svg::StrokeLineJoin);
